...
> ⭐ **27/9/2026 Đợt 407 — ROCKET RACE FIGHT 3D: TÊN LỬA TẤN CÔNG giữa 2 tàu (3 câu liên tiếp = 1 quả, tay robot đưa lên nóc tàu, chạm để bắn, vòng lên lao thẳng xuống, trúng lùi N nấc — Options "Missile" Off/1–10/∞; né 1,5 s cuối bằng trả lời đúng / BOOST (5 câu liên tiếp) / sai-bị-lùi) + đội 2 CAM ĐẬM** (chỉ `templates/rocket-race/`, mô-đun mới `rr3d-missile.js` chép từ myGame mẫu 6c; ⬜ chưa bấm tay TOMKO). Chi tiết chặng Đợt 407 + GHI CHU ROCKET-RACE mục 34.
