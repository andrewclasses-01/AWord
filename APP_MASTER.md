...
> ⭐ **26/9/2026 Đợt 402 — A SHOW SPEED TEMPLATE (activity) hết giờ giống GAME: bàn tối + blur, ô điểm trượt xuống giữa bàn (chơi đơn: giữa khung) rồi đếm kiểu Đợt 395; Fight: bảng kết quả core được bê vào BẢNG GIỮA** (`slideDown`/`countTanks` trong `templates/wordshake/wordshake.js`, bỏ `drainTanks`; không sửa core; ⬜ chưa bấm tay TOMKO). Chi tiết chặng Đợt 402.
