...
> Cập nhật lần cuối: **23/9/2026 (Đợt 376 — PWA: `manifest.webmanifest` (chỉ gắn index.html) + icon iPhone tràn nền + icon Android maskable; standalone, mở vào thư viện; KHÔNG service worker)**. Trước đó Đợt 375 — thanh nút trên cùng giống nhau mọi trang.
