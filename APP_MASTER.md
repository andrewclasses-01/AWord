...
> ⭐ **26/9/2026 Đợt 404 — A SHOW SPEED FIGHT Mode 1: bàn thua (mất màu) hiện TỪ ĐÚNG của đội kia trong ô điền, chữ trắng rơi từng chữ, trong nhịp giữ trước câu mới** (template khai móc `reveal()` có sẵn của core → `m1Reveal`; không sửa core; ⬜ chưa bấm tay TOMKO). Chi tiết chặng Đợt 404.
