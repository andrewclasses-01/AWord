/* ============================================================
   ...
   1. BỌC fetch (đồng bộ, rất nhẹ): lượt gọi REST tới firestore/firebasestorage.googleapis.com được
      ...
      (myLesson web còn một bản chép ở đầu `js/som.js`.) Cờ `window.__acBoc` chặn bọc hai lần —
      AWord nhúng trong iframe của andrewclasses.com vẫn là cửa sổ riêng, tự bọc.
