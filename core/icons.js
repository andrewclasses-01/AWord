...
export const icons = {
  ...
  // ⭐ Đợt 325 — sort button (file-manager "A→Z with an arrow" glyph): three
  // lines of decreasing width (a sorted list) plus an up/down arrow beside them.
  sort: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round"><path d="M4 6h11M4 12h8M4 18h5"/><path d="M18 4v16"/><path d="M14.5 7.5 18 4l3.5 3.5M14.5 16.5 18 20l3.5-3.5"/></svg>`,
